...
print("This program is only a fake virus made for keeping your awareness against real threats. \n\nSorry if you believed that it was real. \n\nKeeping your softwares up to date, avoid downloading files from everywhere (github is a good source because the source code is public), and avoiding to open strange emails are good ways to lower the risk of seeing your computer getting hacked")
time.sleep(100)
